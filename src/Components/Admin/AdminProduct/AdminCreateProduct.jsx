...
export default function AdminCreateProduct() {
    ...
    let [errorMessage, setErrorMessage] = useState({
        ...
        quantity: "Stock Quantity is Mendatory",
                    ...
                    <div className="col-xl-10 col-md-9">
                        ...
                        <form onSubmit={postData}>
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6 mb-3">
                                    <label>Size*</label>
                                    <input type="text" name="size" onChange={getInputData} className={`form-control ${show && errorMessage.size ? "border-danger" : "border-primary"} border-2`} placeholder='Product Size' />
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="discount" onChange={getInputData} className={`form-control ${show && errorMessage.discount ? "border-danger" : "border-primary"} border-2`} placeholder='Product Discount' />
